...
public class CameraHandler : MonoBehaviour
{
    ...
    private static readonly float[] BoundsX = new float[] { -60f, 60f };
    private static readonly float[] BoundsZ = new float[] { -60f, 60f };
    private static readonly float[] ZoomBounds = new float[] { 1f, 175f };
